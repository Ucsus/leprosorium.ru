...
| InteliJ IDEA  | Java | JUnit 5  | Selenide | Selenoid  | Gradle | Jenkins  | REST Assured | GitHub |
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
